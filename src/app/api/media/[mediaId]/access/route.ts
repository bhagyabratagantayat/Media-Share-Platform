...
import { MediaDeliveryType } from '@/server/cdn/types';
...
export async function GET(
  ...
  try {
    ...
    const variant = (searchParams.get('variant') || 'THUMBNAIL').toUpperCase() as MediaDeliveryType;
    ...
    const accessResult = await MediaAccessService.getAuthorizedMediaAccess({
